...
class Menu extends MenuModel
{
  ...
  public function search($params)
  {
    ...
    $query->andFilterWhere(['ilike', 'lower(t.name)', strtolower($this->name)])
      ->andFilterWhere(['ilike', 't.route', $this->route])
      ->andFilterWhere(['ilike', 'lower(parent.name)', strtolower($this->parent_name)]);
